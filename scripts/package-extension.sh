...
mkdir -p "$dist_dir"
temporary_dir="$(mktemp -d "$dist_dir/.youtube-digest-ai-package.XXXXXX")"
temporary_zip="$temporary_dir/youtube-digest-ai.zip"
output_zip="$dist_dir/youtube-digest-ai-v$version.zip"
